...
public abstract class PlaybackInfoListener {
    ...
    protected static String convertStateToString(@State int state) {
        String stateString;
        switch (state) {
    ...
    protected void onLogUpdated(String formattedMessage) {
    }
    ...
    protected void onStateChanged(@State int state) {
    }
